const cyberxDirectDomain = [
    "p.cyberx-ops.com",
    "search-pacifica-log-fdoiqghnpe24jxuhra3mt4vm5y.ap-southeast-1.es.amazonaws.com",
    "ops.ciphertrading.com",
    "ranger1.cyberx.design",
    "*.tky.laozi.pro",
    "one-devops.cyberx.cc",
    "cyberx-server",
    "*.cyberx.com",
    "*.cyberx.cc",
    "*.cyberx-ops.com",
...
const customRules = [
    ...
    "DOMAIN-SUFFIX,popcorn.com,节点选择",
    "DOMAIN-SUFFIX,popcorn.plus,节点选择",
];
...
const rules = [
    ...
    ...customRules,
    // 规则集
    "RULE-SET,cyberx,Cyberx,no-resolve",
